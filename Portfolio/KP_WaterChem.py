    ...
    dbc.Container(
        [
            html.P([
                ...
                html.P("Additionally, the relationships between springs was further explored through additional "
                ...
                dcc.Link(children=['Code from Github Repository'],
                         href='https://github.com/geoskimoto/Kaibab-Plateau-SpringChemistryClustering/blob/master'
                              '/KaibabPlateau-SpringWaterChem-Cluster%2BPCA.ipynb'),
                html.Hr()
            ]),
            dbc.Row([
                dbc.Col([PCA
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Container([
                        html.Br(),
                        html.H3("Hierarchical clustering visual of Kaibab Plateau spring water chemistry"),
                        html.Img(
